...
Source0  : https://download.kde.org/stable/frameworks/5.101/solid-5.101.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.101/solid-5.101.0.tar.xz.sig
...
%prep
%setup -q -n solid-5.101.0
cd %{_builddir}/solid-5.101.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671038891
mkdir -p clr-build
pushd clr-build
