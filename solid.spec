...
Source0  : https://download.kde.org/stable/frameworks/5.49/solid-5.49.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.49/solid-5.49.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1534106309
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Solid.so.5.49.0
