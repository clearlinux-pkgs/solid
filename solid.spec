...
Version  : 5.75.0
Release  : 32
URL      : https://download.kde.org/stable/frameworks/5.75/solid-5.75.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.75/solid-5.75.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.75/solid-5.75.0.tar.xz.sig
...
%prep
%setup -q -n solid-5.75.0
cd %{_builddir}/solid-5.75.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602634300
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/solid-5.75.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/solid/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/solid-5.75.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/solid/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/solid-5.75.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/solid/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/solid-5.75.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/solid/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/solid-5.75.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/solid/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/solid-5.75.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/solid/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/solid-5.75.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/solid/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Solid.so.5.75.0
/usr/lib64/qt5/qml/org/kde/solid/libsolidextensionplugin.so
/usr/lib64/qt5/qml/org/kde/solid/qmldir

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/solid/20079e8f79713dce80ab09774505773c926afa2a
